...
class DoctorDashboard(QMainWindow):
    ...
    def initUI(self):
        ...
        self.load_appointments_button = QPushButton("Load Appointments")
        self.load_appointments_button.clicked.connect(self.load_appointments)
        main_layout.addWidget(self.load_appointments_button)
...
if __name__ == "__main__":
    db_path = "D:/BCSCUN/SEM4/software engineering/Doctor dashboard/call_a_doctor(v3).db"  # Path to your database file
